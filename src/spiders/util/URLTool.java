...
public class URLTool {
	 ...
	 * @throws    MalformedURLException if the given URL is malformed
	 */
	public static Vector<String> getElements(String url) throws MalformedURLException {
	 ...
	 * @return    all elements in the given URLs path
	 */
	public static Vector<String> getElements(URL url) {
	...
	public static boolean urlsOverlap(URL url1, URL url2) {
		...
		Vector<String> elements1 = URLTool.getElements(url1);
		Vector<String> elements2 = URLTool.getElements(url2);
